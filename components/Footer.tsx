      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            ...
            <p className="text-white/30 text-sm">IT Product Architect & Full Stack Developer</p>
          </div>

          <motion.div
            className="glass rounded-full px-6 py-3 flex items-center gap-3 border border-white/5"
            animate={{ borderColor: ["rgba(0,212,255,0.1)", "rgba(0,212,255,0.3)", "rgba(0,212,255,0.1)"] }}
        ...
        <div className="mt-8 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/20 text-sm">
            © {year} Muhammad Imam Nurokhi. All rights reserved.
          </p>
          <motion.div
            ...
            transition={{ delay: 1 }}
          >
            <svg viewBox="0 0 120 30" className="w-24 h-6 opacity-30">
              <motion.path
                d="M5 20 Q15 5 25 20 Q35 35 45 20 Q55 5 65 15 Q75 25 85 15 Q95 5 115 20"
                fill="none"
                stroke="#00D4FF"
                strokeWidth="1.5"
                strokeLinecap="round"
